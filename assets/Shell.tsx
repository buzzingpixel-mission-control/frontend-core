        ...
        <>
            <div>
                        ...
                        <div className="fixed inset-0 flex">
                            ...
                            >
                                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                    ...
                                    <div className="flex grow flex-col gap-y-0 overflow-y-auto bg-white px-6 pb-4">
                                        <div className="flex h-12 shrink-0 items-center font-bold text-lg">
                                            Mission Control
                                        </div>
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                    <div className="flex grow flex-col gap-y-0 overflow-y-auto border-r border-gray-200 bg-white px-6 pt-2 pb-4">
                        <div className="flex h-12 shrink-0 items-center font-bold text-lg">
                            Mission Control
                        </div>
                        <nav className="flex flex-1 flex-col">
