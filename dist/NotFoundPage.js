...
var NotFoundPage = function () {
    (0, RouteContext_1.usePageTitle)('Page Not Found');
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("h1", { className: "mt-4 text-orange-700 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl" }, "Page not found"),
