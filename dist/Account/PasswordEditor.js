...
var PasswordEditor = function (_a) {
    ...
    var _c = (0, react_1.useState)(''), passwordConfirm = _c[0], setPasswordConfirm = _c[1];
        ...
        react_1.default.createElement("div", { className: "text-left" },
            react_1.default.createElement("div", null,
                ...
                react_1.default.createElement("div", { className: "mt-0.5" },
                    react_1.default.createElement("input", { type: "password", name: "password", id: "password", className: "block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm", onChange: function (e) {
                            setPassword(e.target.value);
                        } }))),
            react_1.default.createElement("div", { className: "mt-4" },
                react_1.default.createElement("label", { htmlFor: "password", className: "block text-sm font-medium text-gray-700" }, "Confirm Password"),
                react_1.default.createElement("div", { className: "mt-0.5" },
