...
var RequestMethod_1 = __importDefault(require("./RequestMethod"));
var MakeApiRequest_1 = __importDefault(require("../MakeApiRequest"));
var useApiMutation = function (params) {
    params = params || {};
    var options = params.options || {};
    var prepareApiParams = params.prepareApiParams || (function (prepData) { return (prepData); });
    ...
    return (0, react_query_1.useMutation)(__assign({ 
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        mutationFn: function (prepData) { return __awaiter(void 0, void 0, void 0, function () {
            var apiParams;
            return __generator(this, function (_a) {
                apiParams = prepareApiParams(prepData);
                if (!apiParams.method) {
                    apiParams.method = RequestMethod_1.default.POST;
                }
                return [2 /*return*/, (0, MakeApiRequest_1.default)(apiParams)];
            });
        }); } }, options));
};
exports.default = useApiMutation;
