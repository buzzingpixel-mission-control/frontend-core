...
var SubmitNewUser = function (formValues) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 5, , 6]);
                return [4 /*yield*/, fetch('/api/request/user-admin/edit-user', (0, FetchOptionsBuilder_1.default)(formValues, 'PATCH'))];
            case 1:
                response = _c.sent();
            ...
            case 5:
                error_1 = _c.sent();
                return [2 /*return*/, Promise.reject(new Error('Unable to save user'))];
            case 6: return [2 /*return*/];
        }
    });
}); };
exports.default = SubmitNewUser;
