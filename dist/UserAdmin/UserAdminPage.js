...
var UserAdminPage = function () {
    ...
    var portals = function () {
        if (addUserIsOpen) {
            return (0, createPortal_1.default)(react_1.default.createElement(AddUserOverlay_1.default, { setIsOpen: setAddUserIsOpen }));
        }
        if (editUser) {
            return (0, createPortal_1.default)(react_1.default.createElement(EditUserOverlay_1.default
            /* eslint-disable-next-line @typescript-eslint/ban-ts-comment */
            // @ts-ignore
            , { 
                /* eslint-disable-next-line @typescript-eslint/ban-ts-comment */
                // @ts-ignore
                user: editUser, setEditUser: setEditUser }));
        }
        return null;
    };
    if (users.length < 1) {
