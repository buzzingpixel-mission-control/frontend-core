    ...
    return (react_1.default.createElement("div", { className: "mb-4" },
        ...
        react_1.default.createElement("div", { className: "hidden sm:block" },
            react_1.default.createElement("div", { className: "border-b border-gray-200" },
                react_1.default.createElement("nav", { className: "-mb-px flex space-x-8", "aria-label": "Tabs" }, tabs.map(function (tab) { return (react_1.default.createElement(react_router_dom_1.Link, { key: tab.href, to: tab.href, className: classNames(tab.current
