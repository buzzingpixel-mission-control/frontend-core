    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        (function () {
            if (data.items.length < 1) {
                return (react_1.default.createElement(NoResultsAddItem_1.default, { icon: react_1.default.createElement(solid_1.StopCircleIcon, null), headline: "There are no items in the queue" }));
            }
            return (react_1.default.createElement("div", { className: "bg-white rounded-md shadow-sm px-4 mt-4" },
