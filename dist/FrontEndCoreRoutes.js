...
var FrontEndCoreRoutes = function (setPageName) { return react_1.default.createElement(react_1.default.Fragment, null,
    ...
    react_1.default.createElement(react_router_dom_1.Route, { path: "/user-admin", element: react_1.default.createElement(RequireAdmin_1.default, { setPageName: setPageName },
            react_1.default.createElement(UserAdminPage_1.default, { setPageName: setPageName })) }),
    react_1.default.createElement(react_router_dom_1.Route, { path: "/account", element: react_1.default.createElement(AccountPage_1.default, { setPageName: setPageName }) }),
