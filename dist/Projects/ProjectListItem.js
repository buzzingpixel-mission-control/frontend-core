...
var ProjectListItem = function (_a) {
    ...
    var archiveMutation = (0, ProjectsData_1.useArchiveProjectMutation)(project.id, isArchive);
    return (react_1.default.createElement("li", null,
        react_1.default.createElement("div", { className: "sm:flex items-center justify-between gap-x-6 py-5" },
            react_1.default.createElement("div", { className: "min-w-0" },
                ...
                react_1.default.createElement("div", { className: "mt-1 flex items-center gap-x-2 text-xs leading-5 text-gray-500 truncate" },
                    react_1.default.createElement("p", null, project.slug),
        ...
        (function () {
            ...
            return (react_1.default.createElement(ProjectListItemEditor_1.default, { project: project, setEditorIsOpen: setEditProjectIsOpen }));
        })()));
};
